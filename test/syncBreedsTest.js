...
describe("#breedDetails", () => {
  ...
  it("returns 'No description is available' when a given name has no description ", () => {
    // We expect it to be a function, but will it be?
    const expectedDesc = "No description is available";
    const balinese = breedDetails("Persian");
    assert.equal(expectedDesc, balinese);
  });
});
